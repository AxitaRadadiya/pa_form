...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="no-print">
                <a href="{{ route('admin.reports.event.export', ['event_id' => $selectedEvent->id]) }}"
        ...
        <div class="card mb-3 shadow-sm no-print">
            <div class="card-body py-3">
                <form method="GET" action="{{ route('admin.reports.event') }}" class="form-inline">
        ...
        <div class="card shadow-sm">
            <div class="no-data" style="padding:4rem;">
                ...
                <div style="font-size:1rem;color:#adb5bd;font-weight:500;">Select an event above to view the report</div>
                <div class="small text-muted mt-1">All registrations, members, and awards will appear here</div>
            </div>
        </div>
        @endif
